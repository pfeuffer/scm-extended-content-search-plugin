...
<h1 align="center">
  Extended Content Search
</h1>

Extends the content search with a parser for PDF and office documents

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-extended-content-search-plugin/docs/).
